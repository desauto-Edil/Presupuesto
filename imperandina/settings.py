...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",   # sirve statics sin Nginx/Apache
...
# WhiteNoise — compresión Brotli/gzip de estáticos en producción
STORAGES = {
    "staticfiles": {
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.common.context_processors.trm_global",
            ],
        },
    },
]
