...
def clonar_proyecto_como_version(proyecto_base, usuario):
    ...
    nuevo = Proyecto(
        ...
        margen_material_pct=proyecto_base.margen_material_pct,
        margen_mano_obra_pct=proyecto_base.margen_mano_obra_pct,
        iva_pct=proyecto_base.iva_pct,
        aiu_contratista_pct=proyecto_base.aiu_contratista_pct,
...
class ProyectoService:
    ...
    def crear_desde_solicitud(
        ...
        trm: float = 4200,
        margen_material_pct: float = 20,
        margen_mano_obra_pct: float = 20,
        iva_pct: float = 19,
        aiu_contratista_pct: float = 30,
        moneda: str = "COP",
        ...
        proyecto = Proyecto.objects.create(
            ...
            trm                 = trm,
            margen_material_pct = margen_material_pct,
            margen_mano_obra_pct= margen_mano_obra_pct,
            iva_pct             = iva_pct,
            aiu_contratista_pct = aiu_contratista_pct,
            moneda              = moneda,
