...
_UNIVERSAL_7 = SubsistemaDef(
    ...
    variables=[
        ...
        VariableRequerida(
            ...
            label="Fijaciones por unidad",
            unidad="und",
            default=8.0,
            descripcion="Cantidad de fijaciones Heavy Duty 3\" por cada PowerGrip Universal 7.",
            opciones=[(4, "4 fijaciones"), (8, "8 fijaciones (estándar)")],
        ),
        _VAR_DESPERDICIO,
    ],
    componentes=[
...
_PLUS_TPO = SubsistemaDef(
    ...
    variables=[
        ...
        VariableRequerida(
            ...
            unidad="und",
            default=9.0,
            descripcion="Cantidad de fijaciones Heavy Duty 3\" por cada PowerGrip Plus TPO. Fijo: 9.",
            opciones=[(9, "9 fijaciones (estándar Plus TPO)")],
        ),
        _VAR_DESPERDICIO,
    ],
    componentes=[
