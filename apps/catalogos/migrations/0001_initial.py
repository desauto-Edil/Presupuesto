    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=300)),
                ('precio_actual', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True, verbose_name='Precio actual')),
                ('moneda', models.CharField(choices=[('COP', 'COP'), ('USD', 'USD'), ('EUR', 'EUR')], default='COP', max_length=3, verbose_name='Moneda')),
                ('fecha_actualizacion_precio', models.DateTimeField(blank=True, null=True, verbose_name='Última actualización de precio')),
                ...
                ('proveedor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productos_directos', to='catalogos.proveedor', verbose_name='Proveedor principal')),
